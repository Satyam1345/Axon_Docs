...
export default function UploadPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="w-full max-w-2xl p-8 space-y-6 bg-red-100 rounded-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            required
            className="w-full bg-red-100 p-2 rounded-md border border-red-700 text-red-700"
          />
          <input
            value={persona}
          ...
          <textarea
            ...
            required
            className="w-full bg-red-100 p-2 rounded-md border border-red-700 text-red-700 h-20"
          />
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-2 bg-red-700 hover:bg-red-800 rounded-md disabled:bg-red-200 text-black"
          >
            {isLoading ? (
